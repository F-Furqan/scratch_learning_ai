...
class CourseCommentPolicy
{
    ...
    public function view(User $user, CourseComment $comment): bool
    {
    ...
    public function update(User $user, CourseComment $comment): bool
    {
        return $comment->user_id === $user->id
            || $user->can(PermissionName::ManageComments->value);
    }

    public function delete(User $user, CourseComment $comment): bool
    {
        return $comment->user_id === $user->id
            || $user->can(PermissionName::ManageComments->value);
    }

    public function moderate(User $user, CourseComment $comment): bool
    {
        return $user->can(PermissionName::ManageComments->value);
    }
}
